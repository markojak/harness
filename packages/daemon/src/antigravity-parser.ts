 ...
 */
export async function parseAnnotation(filepath: string): Promise<AnnotationData | null> {
  try {
 ...
 */
export function parseProjectDirName(dirname: string): { name: string; hash: string } | null {
 ...
 */
export async function getActiveProjects(): Promise<Map<string, { name: string; path: string; lastModified: Date }>> {
  const projects = new Map<string, { name: string; path: string; lastModified: Date }>();
 ...
 */
export async function getSessionArtifacts(sessionId: string): Promise<string[]> {
 ...
 */
export async function getSessionCreatedAt(sessionId: string): Promise<Date> {
 ...
 */
export async function getAllSessions(): Promise<AntigravitySession[]> {
